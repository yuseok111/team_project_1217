...
//
///모바일 날짜예약캘린더
function goTab(calendat_body) {
  document.getElementsByClassName("past_day").style.display = "none";
  document.getElementsByClassName("past_day").style.display = "none";
  document.getElementsByClassName("past_day").style.display = "none";
  var obj = document.getElementById(calendat_body);
  obj.style.background = "table-row";
}
...
function buildCalendar() {
  ...
  for (i = 1; i <= lastDate.getDate(); i++) {
    ...
    if (
      ...
      cell.bgColor = "#FAF58C"; //셀의 배경색을 노랑으로 오늘날짜 표시
    }
  }
}
